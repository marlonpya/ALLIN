...
/**
 * Created by ucweb03 on 18/01/2017.
 */

public class DialogAdapter extends ArrayAdapter<ItemSimple> {
    private Context context;
    private ArrayList<ItemSimple> itemSimples;
    private LayoutInflater inflater;

    public DialogAdapter(Context context, ArrayList<ItemSimple> itemSimples) {
        super(context, R.layout.row_dialog_adapter, itemSimples);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) viewHolder = (ViewHolder) convertView.getTag();
            ...
            convertView = inflater.inflate(R.layout.row_dialog_adapter, parent, false);
